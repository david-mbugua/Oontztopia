  ...
  return (
    <div className="home-container">
      ...
      <p className="description">
        Join Oontztopia and take advantage of this moment to treasure with a
        live show unlike anything
        <br /> you’ve seen before. We seek to unite people through their shared
        love for electronic music.
        <br /> We are a culture with a goal of embracing electronic music,
